...
/**
 * Get Districts for a City from RajaOngkir API
 * 
 * GET /admin/rajaongkir/districts?city=151
 */
export const GET = async (
    ...
    try {
        ...
        // getDistricts returns raw normalization. We map it to clean structure.
        ...
        console.error("[RajaOngkir Districts] Error:", error.message)
