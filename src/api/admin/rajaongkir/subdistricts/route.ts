...
/**
 * Get Subdistricts (Kelurahan) for a District from RajaOngkir API
 * 
 * GET /admin/rajaongkir/subdistricts?district=5816
 */
export const GET = async (
    ...
    try {
        ...
        console.error("[RajaOngkir Subdistricts] Error:", error.message)
        res.json({ subdistricts: [] })
    }
}
